...
<section class="error">
  ...
  <div class="error__content">
    <div class="error__message message">
      <h1 class="message__title">TRANG KHÔNG TỒN TẠI</h1>
      <p class="message__text">Rất tiếc, không tìm thấy trang bạn đang tìm ở đây. Liên kết bạn theo dõi có thể bị hỏng hoặc không còn tồn tại. Vui lòng thử lại hoặc quay lại trang chủ.</p>
    </div>
